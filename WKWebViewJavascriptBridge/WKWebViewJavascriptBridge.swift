...
@available(iOS 9.0, *)
class WKWebViewJavascriptBridge: NSObject {
    ...
    func register(handlerName: String, handler: @escaping WKWebViewJavascriptBridgeBase.Handler) {
        base.messageHandlers[handlerName] = handler
    }
    
    func remove(handlerName: String) -> WKWebViewJavascriptBridgeBase.Handler? {
